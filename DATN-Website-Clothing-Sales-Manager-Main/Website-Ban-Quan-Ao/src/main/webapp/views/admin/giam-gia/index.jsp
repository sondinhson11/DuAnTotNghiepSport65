...
<%--                       onclick="return confirm('Bạn có chắc chắn muốn xoá không?')">Xoá</a>--%>
                    <a href="#" class="update-button"
                       ...
                       data-id="${gg.id}" data-hoVaTen="${gg.ma}" data-soPhanTramGiam="${gg.soPhanTramGiam}" data-soTienToiThieu="${gg.soTienToiThieu}"
                       data-soLuong="${gg.soLuong}" data-ngayBatDau="${gg.ngayBatDau}" data-ngayKetThuc="${gg.ngayKetThuc}">
